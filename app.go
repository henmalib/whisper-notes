...
import (
	...
	"github.com/henmalib/whisper-notes/backend/fronthelpers"
...
type App struct {
	...
	Audio   audio.Audio
	Notes   notes.Notes
	Helpers fronthelpers.FrontHelpers
}
...
func (a *App) startup(ctx context.Context) {
	...
	a.Helpers = fronthelpers.NewHelpers(ctx, configHelper, &a.Whisper, &a.Notes)
}
